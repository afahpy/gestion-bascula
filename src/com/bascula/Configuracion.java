...
public class Configuracion extends Config {
	...
	public static final String TIPO_MOVIMIENTO_PRODUCCION = "Producción";
	public static final String SIGLA_TIPO_MOVIMIENTO_PRODUCCION = "TM-PRO";
	...
	public static final String SIS_PRO_TM_PRODUCCION_ORIGEN = "TM_PRODUCCION_ORIGEN";
	public static final String SIS_PRO_TM_PRODUCCION_DESTINO = "TM_PRODUCCION_DESTINO";
