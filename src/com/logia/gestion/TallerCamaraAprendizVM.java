...
public class TallerCamaraAprendizVM extends GenericViewModelApp {
	...
	public boolean isEditable() throws Exception {
		...
		if (this.operacionHabilitada(Configuracion.ALIAS_PERM_EDITAR_TALLER_CAMARA_APRENDIZ)) {
			out = true;
		}
		return out;
	}
	...
	public String getDirectorioAprendiz() {
		String path = "";
		path = this.getSisProp().getPropiedad(Configuracion.SIS_PRO_PATH_TALLER_CAMARA_APRENDIZ);
		return path;
	}
}
