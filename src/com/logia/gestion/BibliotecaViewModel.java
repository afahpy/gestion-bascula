...
public class BibliotecaViewModel extends GenericViewModelApp {

	@Init(superclass = true)
	public void initBibliotecaViewModel() throws Exception {
	}

	@AfterCompose(superclass = true)
	public void afterComposeBibliotecaViewModel() {
	}
